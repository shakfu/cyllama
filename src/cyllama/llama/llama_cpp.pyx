...
cdef class LlamaSampler:
    ...
    def add_dry(self, LlamaVocab vocab, float dry_multiplier,
        ...
        Args:
            ...
            dry_penalty_last_n: How many recent tokens to scan. Values <= 0 are
                clamped to 0 by llama.cpp, which disables the sampler; resolve
                any "whole context" intent to a concrete window before calling.
