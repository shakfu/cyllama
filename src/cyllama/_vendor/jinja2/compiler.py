...
from cyllama._vendor.markupsafe import escape
from cyllama._vendor.markupsafe import Markup
...
class CodeGenerator(NodeVisitor):
    ...
    def visit_Template(
        ...
        self.writeline("from cyllama._vendor.jinja2.runtime import " + ", ".join(exported_names))
